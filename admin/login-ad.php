    ...
    <div class="form mt-5">
      <div class="main_form container mt-4 row">
        ...
        <div class="form_login">
          <form action="process-login-ad.php" method="post">
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label"><strong>Email</strong></label>
              <input type="email" class="form-control" name="Email" id="exampleInputEmail1" aria-describedby="emailHelp" pattern="^([0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*@([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9})$" required />
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label"><strong>Password</strong></label>
              <input type="password" class="form-control" name="PassWord" id="exampleInputPassword1" pattern="\S+" required />
            </div>
        ...
        <div class="hr mt-2">
          <div><hr></div>
          <span class="px-3 text-gray6">or</span>
          <div><hr></div>
        </div>
        <!-- Fb, Gg, Apple -->
