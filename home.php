                                ...
                                <div class="col-md-6 ">
                                    <div class="input-group mb-3">
                                        ...
                                        <form action="find/index.php">
                                            <button class="btn btn-outline-secondary bg-danger" type="submit" style="boder-top-left-radius:0px;boder-top-left-radius:0px">
        ...
        <div class="welcome">
            <div class="header">
                    <div class="col-md-12 text-center mb-5 mt-5">
                            ...
                            <div class="mt-3"><h1><strong>Welcome to Meetup,</strong></h1></div>
            </div>
            <div class="container-fluid">
                <div class="card__container"style="display:flex;align-items:center;justify-content: space-between;border-radius: 10px;">
                    <div class="col-md-12">
                        <div class="row">
                                <div class="col-md-6">
