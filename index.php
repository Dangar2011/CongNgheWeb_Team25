                                            ...
                                            <a class="text-decoration-none"href=""> <h6 class=" mt-2" style="color: rgb(197, 196 ,196);">MON, JAN 3 @ 7:00 AM ICT</h6>
                                                ...
                                                <div class="avatar mt-4">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col">
                                                        <svg xmlns="http://www.w3.org/2000/svg" style="color:rgb(197, 196 ,196);margin-left:100px;" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-up" viewBox="0 0 16 16">
